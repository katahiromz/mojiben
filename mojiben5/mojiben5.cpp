...
static const LPCWSTR g_aszMojiEnglish[] =
{
    ...
    L"会:Meeting, Association, Party, Club, Assembly",
    L"海:Sea",
    L"絵:Picture, Painting, Drawing, Illustration, Sketch",
    L"外:Outside, Foreign",
    L"角:Corner, Angle, Horn",
    L"楽:Easy, Comfort, Music, Fun",
