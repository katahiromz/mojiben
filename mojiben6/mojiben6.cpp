...
static const LPCWSTR g_aszMojiEnglish[200] =
{
    ...
    L"員:Member",
    L"院:Hospital, Infirmary, Graduate School",
    L"飲:Drink, Swallow",
    ...
    L"持:Hold",
    L"式:Formula, Style, Ceremony",
    L"実:Fruit, Truth, Real, Nut",
    L"写:Photo",
    L"者:Person",
    ...
    L"転:Fall Down, Roll",
    L"都:Capital",
    L"度:Degree (of angle or intencity), (Time)",
    L"投:Throw",
    L"豆:Beans",
    L"島:Island",
    L"湯:Hot Water",
    ...
    L"表:Table, Surface",
    L"秒:Seconds",
    L"病:Disease, Illness, Sick",
    L"品:Goods, Product",
    L"負:Negative, Minus, Lose, Bear",
    L"部:Part, Department, Category",
    L"服:Clothes",
    L"福:Good Fortune",
    ...
    L"問:Question, Asking",
    L"役:Role, Position, Battle, Service",
    L"薬:Drug, Medicine",
    L"由:(Reason), (Cause)",
    L"油:Oil",
