...
AppName=Moji No Benkyou (EH)
AppVerName={cm:AppName} 3.1
AppPublisher=katahiromz
VersionInfoProductName=Moji No Benkyou (EH)
VersionInfoDescription=Moji No Benkyou (Elementary High)
...
DefaultDirName={pf}\Moji No Benkyou (EH)
DefaultGroupName={cm:AppName}
DisableProgramGroupPage=yes
OutputDir=.
OutputBaseFilename=mojiben-EH-3.1-setup
Compression=lzma
