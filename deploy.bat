...
mkdir "%NAME1%\data"
mkdir "%NAME1%\data\01Kana"
xcopy /Y /S "data\01Kana\*" "%NAME1%\data\01Kana"

mkdir "%NAME2%\data"
mkdir "%NAME2%\data\02Alphabet"
xcopy /Y /S "data\02Alphabet\*" "%NAME2%\data\02Alphabet"

mkdir "%NAME3%\data"
mkdir "%NAME3%\data\03Number"
xcopy /Y /S "data\03Number\*" "%NAME3%\data\03Number"

mkdir "%NAME4%\data"
mkdir "%NAME4%\data\04Kanji1"
xcopy /Y /S "data\04Kanji1\*" "%NAME4%\data\04Kanji1\"

mkdir "%NAME5%\data"
mkdir "%NAME5%\data\05Kanji2"
xcopy /Y /S "data\05Kanji2\*" "%NAME5%\data\05Kanji2\"

mkdir "%NAME6%\data"
mkdir "%NAME6%\data\06Kanji3"
xcopy /Y /S "data\06Kanji3\*" "%NAME6%\data\06Kanji3\"

mkdir "%NAME7%\data"
mkdir "%NAME7%\data\07Kanji4"
xcopy /Y /S "data\07Kanji4\*" "%NAME7%\data\07Kanji4\"

mkdir "%NAME5%\data"
mkdir "%NAME5%\data\08Kanji5"
xcopy /Y /S "data\08Kanji5\*" "%NAME8%\data\08Kanji5\"

mkdir "%NAME9%\data"
mkdir "%NAME9%\data\09Kanji6"
xcopy /Y /S "data\09Kanji6\*" "%NAME9%\data\09Kanji6\"
